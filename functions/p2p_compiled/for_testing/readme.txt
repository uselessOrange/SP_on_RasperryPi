...
2. Installing the p2p Package

A. Change to the directory that contains the file setup.py and the subdirectory p2p. If 
...
3. Using the p2p Package

The p2p package is on your Python path. To import it into a Python script or session, 
execute:
